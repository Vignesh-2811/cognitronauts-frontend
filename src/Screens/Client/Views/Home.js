    ...
    >
      ...
      >
        ...
        >
          ...
          <Flex justify='center' align='center' mb='20px'> {/* Center-align both horizontally and vertically */}
  <Image
    src={task}
    alt='Task Details'
    maxW='70%'
